...
function setup(){
  ...
  numberPreviewText.style('font-size', '24px');
  ...
  operationPreviewText.style('font-size', '24px');
  ...
  CalculatorBase.position(0, 0);
  OneButton.position(1, height / 2 + 187-49);
  TwoButton.position(70*1.5+2, height / 2 + 187-49);
  ThreeButton.position(140*1.5+3, height / 2 + 187-49);
...
function draw(){
  ...
  ResultText.html(result);
  ResultText.position(width/2-ResultText.width/2, ResultScreen.y+ResultText.height/2-5);
